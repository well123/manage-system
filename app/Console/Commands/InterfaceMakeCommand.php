...
class InterfaceMakeCommand extends GeneratorCommand {
    ...
    protected function getStub() {
        if ($this->option('parent')) {
            return __DIR__ . '/stubs/interface.nested.stub';
        } elseif ($this->option('model')) {
            return __DIR__ . '/stubs/interface.model.stub';
    ...
    {
        $parentModelClass = $this->parseInterface($this->option('parent'));
    ...
    {
        $modelClass = $this->parseInterface($this->option('model'));
    ...
    {
        return [
            ['model', 'm', InputOption::VALUE_OPTIONAL, 'Generate a resource interface for the given model.'],

            ['resource', 'r', InputOption::VALUE_NONE, 'Generate a resource interface class.'],

            ['parent', 'p', InputOption::VALUE_OPTIONAL, 'Generate a nested resource interface class.'],
        ];
    }
